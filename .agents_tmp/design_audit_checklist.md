# Gameplay Design Audit — Core + Balance

Based on the 100 lenses from *The Art of Game Design: A Book of Lenses* (Schell).
...
## Lens #4 — Curiosity
Think about the player’s true motivations — not just the goals your game has set forth, but the reason those goals appeal to the player.
...
Think about your players’ feelings about items, objects, and scores in your game.
...
See everything in your game at once: the four elements and the player experience, as well as how they relate.
...
## Lens #9 — Unification
Consider the reason behind it all — the theme that unifies your game.

- [ ] What is my theme?
- [ ] Am I using every means possible to reinforce that theme?

## Lens #10 — Resonance
Look for hidden power: themes and ideas that resonate deep in the mind of your player.
...
Stop looking at your game and start looking for inspiration everywhere in the world around you.
...
Think of your game as the solution to a problem.
...
Run your design through the eight filters: artistic impulse, demographics, experience design, innovation, business/marketing, engineering, social/community, and playtesting.
...
Stop thinking positively and start seriously considering what could go wrong with your design — then act to reduce those risks.
...
## Lens #16 — Player
Stop thinking about your game, and start thinking about your player.
...
## Lens #17 — Pleasure
Think about the kinds of pleasure your game does and does not provide.
...
## Lens #18 — Flow
Consider what is holding your player’s focus.
...
## Lens #19 — Needs
Stop thinking about your game, and start thinking about what basic human needs it fulfills.
...
## Lens #20 — Judgment
Decide whether your game is a good judge of the players.
...
Think about the space in which your game really takes place when all surface elements are stripped away.
...
Think about what information changes during your game, and who knows about those changes.
...
## Lens #23 — Emergence
Make sure your game has interesting qualities of emergence.
...
## Lens #24 — Action
Think about what your players can do and what they can’t, and why.
...
## Lens #25 — Goals
Ensure the goals of your game are appropriate and well-balanced.
...
- [ ] Do I have a good balance of shortand long-term goals?
- [ ] Do players have a chance to decide on their own goals?

## Lens #26 — Rules
Look deep into your game until you can make out its most fundamental, foundational rules.
...
## Lens #27 — Skill
Stop looking at your game, and start looking at the skills you are asking of your players.
...
Think about the chance of different events occurring in your game, and what those mean to your player.
...
## Lens #29 — Chance
Focus on the parts of your game that involve randomness and risk, keeping in mind that those two things are not the same.
...
## Lens #30 — Fairness
Think carefully about the game from each player’s point of view. Taking into account each player’s skill level, find a way to give each player a chance of winning that each will consider to be fair.
...
Help determine how to balance skill and chance in your game.
...
## Lens #40 — Reward
Everyone likes to be told they are doing a good job.
...
- [ ] For elements with only one or two purposes, can some of these be combined or discarded?
- [ ] For elements with multiple purposes, is there some way a new element could combine even more purposes?
...
## Lens #45 — Imagination
All games have some element of imagination and some element of connection to reality.
...
## Lens #47 — Balance
There are many types of game balance, and each is important. However, it is easy to get lost in the details and forget the big picture.

- [ ] Does my game feel right? Why or why not?

## Lens #48 — Accessibility
Ensure the game is easily approachable — players should be able to begin without confusion.
...
## Lens #56 — Transparency. If a player doesn’t know what mode they are
In, they are going to be confused and frustrated. The old Unix text editing system, vi (pronounced “ V.I. ” ) was a symphony of confusing modes. Most people would expect that a text editor, when it started up, would be in a mode that would allow you to enter text. But not so for vi. It was actually in a mode where each letter of the keyboard would either issue a command, like “delete line, ” or it would put the editor into a new mode. But hitting these keys would give no feedback about what mode you were in. If you actually wanted to enter text, you had to type a letter “ i, ” CHANNELS OF INFORMATION and then you would be in text insert mode, which looked exactly like command entry mode. It was impossible to figure out on your own, and even seasoned vi users would occasionally get confused about what mode they were in. Some great ways to make your modes look different in video games are listed next.
...
Choosing how to map game information to channels and dimensions is the heart of designing your game interface.
...
## Lens #60 — Modes
An interface of any complexity is going to require modes.
...
Consider the moment-by-moment interest of the player across the whole experience.
...
## Lens #70 — Story
Decide whether your game needs a story at all, and what role it should play.
...
Make sure your characters are doing everything your game needs them to do.
...
Ensure that the traits of a character show in what they say and do.
...
Improve your characters’ relationships — make a list of all your characters and study how they relate.
...
## Lens #86 — Community
Make sure your game fosters strong community.
...
## Lens #87 — Griefing
Make sure griefing in your game is minimized.
...
## Lens #88 — Love
Examine how your game helps players feel warm feelings toward each other.
...
## Lens #89 — Team
Make sure your team is operating like a well-oiled machine.
...
## Lens #90 — Documentation
Write the documents you need, and skip the ones you don’t.

- [ ] What do we need to remember while making this game?
- [ ] What needs to be communicated while making this game?

## Lens #91 — Playtesting
Playtesting is your chance to see your game in action.
...
## Lens #92 — Technology
Make sure you are using the right technologies in the right way.
...
## Lens #93 — Crystal Ball
Think through where game technology is going, and make your answers as concrete as possible.
...
## Lens #94 — Client
Know what your client really needs, not just what they say they want.
...
## Lens #95 — Pitch
Ensure your pitch is as good as it can be.
...
## Lens #97 — Transformation
Games create experiences, and experiences change people.

- [ ] How can my game change players for the better?
- [ ] How can my game change players for the worse?

## Lens #98 — Responsibility
To live up to your obligations as a game designer.
...
## Lens #100 — Your Secret Purpose
To make sure you are working toward your one true purpose.
